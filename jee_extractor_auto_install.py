...
def check_and_install_packages():
    ...
    required_packages = {
        ...
        'pix2text': 'pix2text',
        'numpy': 'numpy',
        'openpyxl': 'openpyxl'  # Required for Excel operations
    }
    
    missing_packages = []
    
    print("=" * 60)
    print("JEE Question Extractor - Package Manager")
    print("=" * 60)
    ...
    for module, package in required_packages.items():
        if module == 'tkinter':
            ...
            try:
                ...
                print(f"✗ {module} - Missing (Please install python3-tk)")
                if sys.platform.startswith('linux'):
                    print("  Run: sudo apt-get install python3-tk")
                elif sys.platform == 'darwin':
                    print("  Run: brew install python-tk")
        else:
    ...
    if missing_packages:
        ...
        venv_dir = Path("jee_extractor_env")
        ...
        if response.lower() == 'y':
            ...
            print("Please restart the application to load the new packages.")
            print("=" * 60)
            ...
            print("The application cannot run without the required packages.")
            sys.exit(1)
    else:
...
def main():
    """Main entry point"""
    print("\nStarting JEE Question Paper Extractor...")
    print("=" * 60)
